...
from transformers import (
    ...
    DataCollatorForLanguageModeling, AlbertTokenizer, 
...
NAME = "" # !!!!! this name will be applied to load data, save model checkpoints, and the actual model
...
# Model configuration
config = LlamaConfig(
    vocab_size=30000,               # Different from "Vocab size = 16384" in the paper (and different tokenizer too)
    ...
    max_position_embeddings=512,    # Corresponds to AlbertTokenizer, different from "Max. seq. length = 256" in the paper
    use_cache=False
)
...
training_args = Seq2SeqTrainingArguments(
    ...
    save_strategy="epoch",
    num_train_epochs=1,                         # Different from "Epochs = 20" in the paper
    learning_rate=3e-4,
